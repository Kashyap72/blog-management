        ...
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                ...
                <!-- Form to reset password -->
                    ...
                    <form class="form-horizontal mt-3" action="<?= BASE_URL ?>admin/resetpassword" method="post">
                        <div class="row pb-4">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control form-control-lg" placeholder="New Password" aria-label="New Password" name="new_password" required="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row pb-4">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control form-control-lg" placeholder="Confirm New Password" aria-label="Confirm Password" name="confirm_password" required="" />
                                </div>
                            </div>
                        </div>
